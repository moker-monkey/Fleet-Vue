<template>
  <el-row class="wrap" :gutter="10">
    ...
    <el-col :span="24" class="item">
      <card1 :data="card_data.rechargeAndConsumeMoney" :options="{ tool: false, size: 'big' }">
        <template #content>
    ...
    <el-col :span="12" class="item">
      <card1
        :data="card_data.haveBalanceUser"
        :options="{ tool: false, size: 'middle' }"
      >
        <template #content>
          <lineCharts style="width: 100%; height: 200px"></lineCharts>
...
export default class extends Vue {
  ...
  public mounted() {
    ...
    this.$api.balanceAnalysis.GET().then((res: any) => {
